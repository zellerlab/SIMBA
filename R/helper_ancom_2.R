# Downloaded from
# https://raw.githubusercontent.com/FrederickHuangLin/ANCOM/master/scripts/ancom_v2.1.R
# on 2021-02-18

# could be a more efficient way of computing ANCOM p-values?
#
# removed plotting part from the function since not needed
